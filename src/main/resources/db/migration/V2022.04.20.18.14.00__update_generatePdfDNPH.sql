...
<body>
    <div class = "apdungfont" style="margin-left: 150px;margin-right: 150px; word-wrap:break-word;">
        <div class="row-text">
            <h3 style="text-align: center;">ĐỀ NGHỊ PHÁT HÀNH THƯ TÍN DỤNG (L/C) ONLINE</h3>
        </div>
        <div class="row-text">
            <p style="font-size: 19px;">Kính gửi:</p>
        </div>
        <div class="row-text">
        ...
        <div class="row-text">
            <p style="font-size: 19px;">Tên khách hàng: $corporateBuy</p>
        </div>
        <div class="row-text">
            <p style="font-size: 19px;">Mã khách hàng: $corporateCode</p>
        </div>
        <div class="row-text">
            <h4>
